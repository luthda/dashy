...
Dashy — a dashboard application. The repository is in early stages; update this file as the codebase takes shape.
...
| `/code-reviewer-backend`  | Explicit backend code review                                               |
| `/code-reviewer-frontend` | Explicit frontend code review                                              |
